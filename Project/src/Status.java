...
public enum Status {
	...
	INVALID_PASSWORD("Invalid password. Password must be at least 6 characters and contain at least one special character."),
	WRONG_PASSWORD("Invalid username or password. Please try again!"),
